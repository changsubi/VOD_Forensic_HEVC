...
if (!empty($advancedCustomUser->userMustBeLoggedIn) && !empty($advancedCustomUser->userMustBeLoggedInCloseButtonURL)) {
    ...
    <nav class="navbar navbar-default navbar-fixed-top " id="mainNavBar">
                                                ...
                                                if (!empty($config->getEncoderURL())) {
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="#" onclick="$('#formEncoder').submit();
                                                                return false;">
                                                            <span class="fa fa-cog"></span> <?php echo empty($advancedCustom->encoderButtonLabel) ? __("Content upload") : $advancedCustom->encoderButtonLabel; ?>
                                                        </a>
                                                    </li>
                                                    <?php
                                                } else {
		...
		?>
		<li>
			<form id="formCustom1" method="post" action="<?php echo $config->getEncoderURL() . "2"; ?>" target="encoder"  autocomplete="off" >
				<input type="hidden" name="webSiteRootURL" value="<?php echo $global['webSiteRootURL']; ?>"  autocomplete="off"  />
				<input type="hidden" name="user" value="<?php echo User::getUserName(); ?>"  autocomplete="off"  />
				<input type="hidden" name="pass" value="<?php echo User::getUserPass(); ?>"  autocomplete="off"  />
				<input type="hidden" name="custom" value="custom1"  autocomplete="off"  />
			</form>
			<a href="#" onclick="$('#formCustom1').submit(); return false;">
				<span class="fa fa-cog"></span> <?php echo "Content ID" ?>
			</a>
		</li>
		<?php
					    }
