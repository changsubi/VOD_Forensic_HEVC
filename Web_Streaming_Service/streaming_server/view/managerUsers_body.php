            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-compact"  id="updateUserForm" onsubmit="">
                        ...
                        <label for="inputPhone" class="sr-only"><?php echo __("Phone Number"); ?></label>
                        <input type="text" id="inputPhone" class="form-control " placeholder="<?php echo __("Phone Number"); ?>" >
