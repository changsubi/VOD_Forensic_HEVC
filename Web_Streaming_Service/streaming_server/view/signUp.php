                ...
                <div class="col-xs-12 col-sm-12 col-lg-8">
                    <form class="form-compact well form-horizontal"  id="updateUserForm" onsubmit="">
                        <fieldset>
                            ...
                            <?php } ?>
                            <div class="form-group">
                                <label class="col-sm-4 control-label hidden-xs"><?php echo __("Phone Number"); ?></label>
                                <div class="col-sm-8 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                                        <input  id="inputPhone" placeholder="<?php echo __("Phone Number"); ?>" class="form-control"  type="text" value="" required >
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
