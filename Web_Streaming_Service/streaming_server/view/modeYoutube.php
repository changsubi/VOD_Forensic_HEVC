...
?>
	...
	<div id="loading" style="z-index: 1100; position: absolute; left: 0; right: 0; width: 100%; height: 100%; background-color: rgba(133,132,132,0.5);display: none;">
    	<div data-loader="rectangle" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);"></div>
        <p style="top: 53%; font-size: 3rem; color: white; left: 50%;transform: translate(-50%, -50%);position: absolute;">0%</p>
	</div>
    <style>
        .nonscroll {
            overflow-y: hidden;
