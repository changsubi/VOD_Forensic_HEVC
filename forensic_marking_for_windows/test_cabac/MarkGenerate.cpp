...
string HashMaker(std::string user_name, std::string user_email, std::string user_phone, std::string user_ip, std::string user_browser, std::string cur_time)
{	
	...
	input = user_name + user_email + user_phone + user_ip + user_browser + cur_time; //+ std::to_string(prng_val); -> if 해시에 랜덤은 넣을것인가?
